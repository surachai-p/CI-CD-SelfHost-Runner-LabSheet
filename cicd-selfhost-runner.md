...
คำตอบ: คือรูปแบบที่ตัว Runner (เครื่องเซิร์ฟเวอร์เรา) จะเป็นฝ่าย "วิ่งไปถาม" GitHub เองว่ามีงานใหม่ให้ทำหรือไม่ ผ่านการเชื่อมต่อ HTTPS ปกติ แทนการรอให้ GitHub ส่งข้อมูลมาหา

ข้อดี: ไม่ต้องเปิดพอร์ตขาเข้า (Inbound Port) บน Firewall หรือทำ Port Forwarding ทำให้เครื่องเซิร์ฟเวอร์มีความปลอดภัยสูงและตั้งค่าได้ง่ายแม้จะอยู่ในเครือข่ายภายใน (Private Network)
...
<summary>คำตอบ</summary>
 ...
 เขียนคำตอบลงในช่องนี้
คำตอบ: เพราะ Pull-based ไม่ต้องเปิดช่องโหว่ให้โลกภายนอกเชื่อมต่อเข้ามายังเครื่องเซิร์ฟเวอร์โดยตรง ลดความเสี่ยงจากการถูกโจมตีผ่านเครือข่าย หรือการสแกนหาพอร์ตที่เปิดทิ้งไว้ หากเซิร์ฟเวอร์ไม่ต้องฟัง (Listen) คำสั่งจากภายนอก โอกาสที่จะถูกเจาะระบบจากอินเทอร์เน็ตก็ลดลงอย่างมาก
...
<summary>คำตอบ</summary>
 ...
 เขียนคำตอบลงในช่องนี้
คำตอบ: เพราะบุคคลภายนอกสามารถส่ง "Pull Request" ที่แฝงคำสั่งอันตราย (Malicious Code) ในไฟล์ Workflow มาให้เครื่องเราทำงานได้ หากรันบนเครื่องเราเอง ผู้โจมตีอาจขโมยข้อมูลในเซิร์ฟเวอร์ เข้าถึงเครือข่ายภายใน หรือใช้เครื่องเราเป็นฐานในการโจมตีผู้อื่น ซึ่งเป็นอันตรายอย่างมากต่อความมั่นคงปลอดภัยขององค์กร
...
<summary>คำตอบ</summary>
 ...
 เขียนคำตอบลงในช่องนี้
คำตอบ: Nginx คือซอฟต์แวร์ Web Server ประสิทธิภาพสูงที่ทำหน้าที่จัดการ Traffic บนเครือข่าย
ความสำคัญของ Reverse Proxy: ทำหน้าที่เป็น "ด่านหน้า" รับ Request จากผู้ใช้แล้วส่งต่อไปยังแอปพลิเคชัน (Node.js) ช่วยเพิ่มความปลอดภัย (ซ่อนพอร์ตจริงของแอป), จัดการ SSL (HTTPS), ช่วยทำ Cache เพื่อเพิ่มความเร็ว และสามารถขยายระบบ (Load Balancing) ได้ง่ายในอนาคต
