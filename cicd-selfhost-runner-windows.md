...
Pull-based Model ของ Self-Hosted Runner คือรูปแบบการทำงานที่ ตัว Runner จะเป็นฝ่ายเชื่อมต่อออกไป (pull) เพื่อขอรับงาน (job) จาก GitHub Actions เอง แทนที่ GitHub จะเชื่อมต่อเข้ามาหาเครื่อง Runner โดยตรง
# ข้อดี
- ไม่จำเป็นต้องเปิดพอร์ตจากภายนอกเข้าเครื่องเซิร์ฟเวอร์
- ลดความเสี่ยงจากการถูกโจมตีจากภายนอก
- ควบคุมความปลอดภัยของเครือข่ายได้ง่าย
- เหมาะกับระบบที่อยู่หลัง Firewall หรือ NAT
...
<details>
<summary>คำตอบ</summary>
Pull-based ปลอดภัยกว่า Push-based เพราะเครื่อง Runner ไม่เปิดรับการเชื่อมต่อจากภายนอก แต่เป็นฝ่ายเชื่อมต่อออกไปหา GitHub เอง ทำให้ลดโอกาสที่ผู้ไม่หวังดีจะเข้าถึงระบบโดยตรง
ในขณะที่ Push-based ต้องเปิดพอร์ตให้ระบบภายนอกเชื่อมต่อเข้ามา ซึ่งเพิ่มความเสี่ยงด้านความปลอดภัย เช่น การโจมตีผ่านเครือข่ายหรือการเข้าถึงโดยไม่ได้รับอนุญาต
...
npm ci ถูกออกแบบมาเพื่อใช้งานในสภาพแวดล้อม production ในขณะที่ npm install อาจอัปเดต dependency ใหม่โดยไม่ตั้งใจ ทำให้ผลลัพธ์ของระบบไม่คงที่
...
Self-Hosted Runner ไม่ควรถูกใช้งานกับ Public Repository เนื่องจาก ทุกคนสามารถสร้าง Pull Request ได้ ซึ่งอาจมีโค้ดอันตรายแฝงเข้ามา
...
Nginx คือ Web Server และ Reverse Proxy ที่มีประสิทธิภาพสูง ใช้สำหรับจัดการการรับ–ส่ง HTTP/HTTPS Request
# ความสำคัญของ Reverse Proxy
- ซ่อนโครงสร้างภายในของระบบ
- กระจายโหลดไปยังหลายบริการ (Load Balancing)
- จัดการ SSL/TLS ได้จากจุดเดียว
- เพิ่มความปลอดภัยและความยืดหยุ่นของระบบ
...
<details>
<summary>คำตอบ</summary>
ความแตกต่างหลักระหว่างการรัน Runner บน Windows และ Linux ได้แก่
...
# คำสั่งระบบ
คำสั่งหลายอย่างไม่สามารถใช้ร่วมกันได้
</details>

---
https://github.com/rattapum1269/nodejs-cicd-selfhosted.git
## 📚 เอกสารอ้างอิง
